...
test('v4.8.5 commute adapter carries continuity rules and version wiring', async () => {
  ...
  expect(html).toContain('flowz-v4.8.5-commute-continuity.js?v=4.8.5');
  expect(html).toContain('v4.8.5 (2026.8.21)');
  expect(entry).toContain("params.set('v','4.8.5')");
  expect(pkg.version).toBe('4.8.5');
});

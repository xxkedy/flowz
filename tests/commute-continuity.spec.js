...
test('v4.8.6 build retains commute continuity, conversation quality, and low-load shadowing override', async () => {
  ...
  expect(html).toContain('flowz-v4.8.5-commute-continuity.js?v=4.8.6-r7');
  expect(html).toContain('class="version"');
  expect(html).toContain('data-release="4.8.6-r10"');
  expect(html).toContain('data-release-label="v4.8.6 r10 · 09/09"');

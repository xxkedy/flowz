...
- Keep the Phrase Bank to four broad sections so it stays fast to scan: COMMUTE / REPLY / NATIVE / PRACTICAL. COMMUTE includes real commute phrases plus Flowz-control phrases kedy actually says often; REPLY includes replies and conversation-extending bridges; NATIVE holds short high-frequency natural expressions; PRACTICAL holds clarification, repair, and stuck phrases. Do not add a new category unless one of these four genuinely cannot hold it.
